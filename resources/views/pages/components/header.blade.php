                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__right__language">
                            ...
                            <ul>
                                <li><a href="{!! route('change-language', ['vn']) !!}">{{ trans('message.vn')}}</a></li>
                                <li><a href="{!! route('change-language', ['en']) !!}">{{ trans('message.english')}}</a></li>
                            </ul>
                        </div>
                                ...
                                @else
                                    <li class="nav-item dropdown ">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="{{asset('favorite')}}">
                                                {{ trans('message.favorite') }}
                                            </a>
                                            <a class="dropdown-item" href="{{route('get_history_product', Auth::user()->id)}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    <ul>
                        <li><a href="{{asset('favorite')}}"><i class="fa fa-heart"></i> <span>{{ trans('message.totalfavorite')}}</span></a></li>
                        <li><a href="{{route('showcart')}}"><i class="fa fa-shopping-bag"></i> <span>{{Cart::count()}}</span></a></li>
                    </ul>
